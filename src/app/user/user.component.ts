          ...
          if (res.retcode === 0) {
            if (res.payload) {
              if (res.payload !== '') {
                ...
                // tslint:disable-next-line:max-line-length
                this.dataOrder = pageFlag === 'last' || pageFlag === '' ? JSON.parse(res.payload).orders : JSON.parse(res.payload).orders.reverse();
