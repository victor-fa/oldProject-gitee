...
import { IAccountListItemOutput, LoginItemInput, IRolesItemInput,
  IRolesItemOutput, AddRolesItem, AddCustomerItem, CustomerItem, LoginItemOutput, LoginUser } from '../model/user.model';
...
export class AccountService extends AppServiceBase {
  ...
  /** 获取员工信息 */
  getCustomer(id: String): Observable<IResponse<LoginUser>> {
    const url = this.fullUrl(userApiUrls.users) + '/' + id;
    return this.httpClient
      .get<IResponse<LoginUser>>(url, this.options);
  }
