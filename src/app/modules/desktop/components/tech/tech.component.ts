            ...
            pages: [
                {
                    ...
                    desc: '比方，比如玩家玩了什么游戏，玩的怎么样，打到第几关了，充了多少钱，这个虽然游戏开发公司能知道，但是搜索引擎公司却无法获取这个信息。' +
                        '然后可能可以知道他患了什么病，现在健康状况是什么样的，比如网络搜素可能知道他去了哪家医院，搜了什么病，但是具体病情肯定是不知道的，然后游戏公司肯定收集不到的。' +
                        '这就是我们比巨头公司在数据上的优势，而且搜索得来的数据只能说明用户搜索了什么，而我们是用户亲口告诉我们具体情况，同时还能理解用户在相关业务里所有的数据。',
                    name: '精准数据',
                ...
                },
                {
                    ...
                    desc: '现在知名度比较高的几个机器人都是闲聊为主，顶多增加一些调闹钟、查天气的关键词查询式的助理功能。' +
                        '齐悟可以根据企业用户需求定制业务逻辑，处理更加复杂的业务，如买机票、订酒店、点外卖，通过一系列多轮对话搜集用户意图或直接一次性理解多句复杂句子表的达，这是传统一问一答聊天机器人做不到的。' +
                        '并且支持多个话题跳转，网状逻辑，而不是传统客服的线性菜单式逻辑。',
                    name: '复杂逻辑',
                ...
                },
                {
                    ...
                    desc: '齐悟的核心引擎已经开发了10多余年，可以轻松实现快速定制，更重要的是开发费用相比竞争对手更低，而且迭代速度快，版本更新灵活，具有绝对的竞争优势。' +
                        '齐悟技术的核心是采用独特的偏重实例层的多层语义知识网络，基于图模板映射的规则归纳和知识推理，从而实现多轮人机对话及上下文语义理解。',
                    name: '自主研发',
                ...
                },
                {
                    ...
                    desc: '传统的智能客服是通过机器学习的方式进行训练，会产生两个问题：需要甲方提供大量语料数据进行训练，许多企业往往无法提供数据；同时每一次定制都需要甲方出人力进行大量的人工标记，费时劳力。' +
                        '可以说，他们是人工堆积出来的智能，而不是真正的人工智能。齐悟只需客户提供给人类客服学习的《培训手册》或标准的业务流程图，齐悟就能建立自己的逻辑、快速学习处理业务，实现接近真人的自然交互。' +
                        '后续需要增删知识，只需要在神经网络中增加或减少节点即可完成需求。',
                    name: '成本优势',
