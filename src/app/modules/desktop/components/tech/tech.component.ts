            ...
            pages: [
                {
                    ...
                    desc: '打个比方，虽然游戏开发公司知道玩家玩了什么游戏，等级，关卡和充值数目，但搜索引擎公司却无法获取这个信息。再比如通过用户的网络搜索可能知道他去了哪家医院，搜了什么病，但是具体病情肯定是不知道的。搜索得来的数据只能说明用户搜索了什么，相比巨头公司，齐悟在数据上的优势在于用户亲口告诉我们具体情况，同时我们还能理解用户在相关业务里所有的数据。',
                    name: '精准数据',
                ...
                },
                {
                    ...
                    desc: '齐悟的引擎已经开发了10多年，可以轻松实现快速定制，更重要的是开发费用相比竞争对手更低，而且迭代速度快，版本更新灵活，具有绝对的竞争优势。' +
                        '齐悟技术的核心是采用独特的偏重实例层的多层语义知识网络，基于图模板映射的规则归纳和知识推理，并能做到“记忆，认知，理解，问答”，从而实现多轮人机对话及上下文语义理解。',
                    name: '自主研发',
