    ...
    products: [Product] = [
        ...
        },
        {
            ...
            desc: [
                ...
                '智能问诊系统将对病患的初步问诊以及日常家庭健康的监控有着非常关键的价值以及深远影响。会实际的解决当前医患关系紧张，有效缓解医院的就诊压力以及给医生提供更有针对性的医疗数据去解决患者的需求。齐悟未来将与“医和你”一起合力做出全科型的筛查初诊系统，让看病不再难，打造属于中国版的“Watson”。'
            ],
            name: '智慧医疗',
        ...
        },
        {
            ...
            desc: [
                '广告是最快的资讯信息传播媒介，如何让广告能够更有效的打动人心，达到快速传播的效应？广告传统模式已经不足以打动受众，因为被动的广告销售已经让受众疲于应付。互动广告正好可以打破这个僵局，可以让广告“活”起来。通过与二次元IP 或者时下流行的元素结合，我们可以在电梯广告，触摸交互广告屏中投放广告，让广告中的“主角”与观众进行语音互动，通过与“齐悟”的技术优势结合，广告已经不再是传统的单向输出，转为双向互动的广告传播，有效的将信息传递给受众。也可以更好的深入了解客户的想法，通过收集用户数据进行精确的营销，达到良好的市场沟通，针对每个客户的需求，将会把营销顾客的反馈直接给到客户，让广告更有效的传播，大大降低成本。同时也因为广告形式活泼生动，将会广受欢迎，也将为产品快速的打开一个新的传播途径，达到提高宣传效果增加广告转化率，同时提升品牌的建设和良好的竞争力。让品牌形象的科技感大大增加，同时也利用虚拟偶像相比明星代言更有号召力，却相对低廉成本来降低广告投放和制作成本。让广告更贴近生活更融入用户的体验。'
            ],
            name: '交互广告',
